...
----
This is Part 3 of a Crime Analysis series on Denver  

* [Crime Analysis - Denver-Part 1](http://stoltzmaniac.com/crime-analysis-denver-part-1/)
...
* We'll focus only on those that are classified as OFFENSE CATEGORY ID "drug-alcohol"
...
* First - what are the top 15 crimes types (as defined by CRIME TYPE ID)?
* Second - how have the number of incidents reported changed over the last 3 years?   

**Observations**

* Liquor possession is the highest of drug-alcohol violations
* Marijuana ranks third, just after possession of drug paraphernalia
* Methamphetamine break the pattern of decline - it actually grew from 2014-2016
* Cocaine and Heroin possession also grew over the period, but at a much smaller volume than methamphetamine  
...
* Possession dropped by 51% from 2015 to 2016 (holding months constant)
...
* Liquor possession dominates the number of incidents
* With liquor manufacturing so low, it appears as if bootleggers and moonshiners probably don't thrive in Colorado
* Appears as if there's a downward trend in the number of incidents each year
...
* There is a very rapid growth in methamphetamine incidents
* Steady growth since 2012 - hopefully this declines moving forward
* FYI - I didn't misspell "methamphetamine" - it was already in the data set as such  
...
* While the growth in terms of percentage was very high for manufacturing, the volume is very low
* Large percentage growth still occurs in possession but not sales crimes
...
Code used in this post is on my [GitHub](https://github.com/stoltzmaniac/Denver-Crime-Analysis.git)