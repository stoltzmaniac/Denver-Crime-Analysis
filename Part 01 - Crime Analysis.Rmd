...
**Initial Impressions**
Having isolated only months that have occurred in each year, we've seen traffic increase each year. The most rapid growth seemed to occur between 2012 - 2014. I'll have to dig into those years in order to see if there's evidence of a change in crime rate or if something else is hiding in the data.
